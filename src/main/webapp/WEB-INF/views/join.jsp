...
$(function(){
	...
	//회원가입 버튼(회원가입 기능 작동)
	   ...
	   if ($(".phoneck_wrap").css("display") == "none") {
			...
			$.ajax({
				...
				success:function(data){
					code = data;
					 ...
					 phoneCheck = true;
					$(".phoneck_wrap").css("display","block");
				}
			})	
		});//end 휴대폰 유효성 검사
...
<div id="container">	
	...
	<form id="join_form" action="join" method="post">
	 <input type="hidden" name="${_csrf.parameterName }" value="${_csrf.token }"> 
		...
		<h3><label class="form_label" for="id">아이디</label></h3>
			<input type="text" class="input" name="id" id="id">		
			 <span clas="error_msg" id="idMsg" style="display:none"></span>
			 <span class="success_msg" id="idMsg" style="display:none"></span>
		</div>
		
		<div class="input_group">
		<h3><label class="form_label" for="pwd">비밀번호</label></h3>
			<input type="password" class="input" name="pwd" id="pwd"><br>
			 <span class="error_msg" id="pwdMsg"></span>
		</div>	 
		<div class="input_group">
		<h3><label class="form_label" for="pwdck">비밀번호 확인</label></h3>
			<input type="password" class="input" name="pwdck" id="pwdck"><br>
			 <span class="error_msg" id="pwdckMsg"></span>
			 <span class="success_msg" id="pwdckMsg"></span>
		</div>
		
		<div class="input_group">
		<h3><label class="form_label" for="name">이름</label></h3>
		...
		<div class="input_group">
		<h3><label class="form_label" for="nickname">닉네임</label></h3>
			<input type="text" class="input" name="nickname" id="nickname"><br>
			 <span class="error_msg" id="nickNameMsg" style="display:none"></span>
			 <span class="success_msg" id="nickNameMsg" style="display:none"></span>
		</div>	
		
		<div class="input_group">
		<h3><label class="form_label" for="email">이메일</label></h3>
		...
		<div class="input_group">
		<h3><label class="form_label" for="phone">휴대전화</label></h3>
			<div class="phone_wrap">
				<input type="number" class="input" pattern="[0-9]*" name="phone" id="phone" placeholder="숫자만 입력하세요" max="11">
				<input id="btnSend"  type="button"  disabled="disabled" value="인증코드 받기"><br>
			</div>
				
			<div id="input_group">
			<div class="phoneck_wrap" style="display:none">
				<input type="number" class="input" id="userCode">
